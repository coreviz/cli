...
/** Get the target organization ID stored in sync state (overrides the default from /api/me) */
export function getTargetOrgId(state) {
    return state.organizationId ?? null;
}

/** Store a target organization ID in the sync state */
export function setTargetOrgId(state, organizationId, organizationName) {
    state.organizationId = organizationId;
    if (organizationName) state.organizationName = organizationName;
}
